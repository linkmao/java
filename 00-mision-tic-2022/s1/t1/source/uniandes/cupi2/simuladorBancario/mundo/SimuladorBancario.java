...
public class SimuladorBancario
{
    ...
    {	
    	double ahorroSinInteres = ahorros.darSaldo()/Math.pow(1+ahorros.darInteresMensual(), mesActual-1); 
        double cdtSinInteres= inversion.calcularValorPresente(mesActual)/Math.pow((1+inversion.darInteresMensual()), mesActual-1);
    	return calcularSaldoTotal()-ahorroSinInteres-cdtSinInteres-corriente.darSaldo();
