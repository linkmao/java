...
public class PanelOpciones extends JPanel implements ActionListener
{
    ...
    public PanelOpciones( InterfazLineasTelefonicas pPrincipal )
    {
        ...
        //Botón opción 2
        btnOpcion2 = new JButton( "Presupuesto" );
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        {
        	String strValor = JOptionPane.showInputDialog( principal, "Introduzca el costo objetivo", "Presupuesto", JOptionPane.QUESTION_MESSAGE );
            principal.reqFuncOpcion2(strValor );
        }
